...
class ShockWave extends ParticleSystemComponent {
  ShockWave({
          ...
          particle: TranslatedParticle(
            ...
            child: ComputedParticle(
              renderer: (canvas, particle) {
                ...
                final paint = Paint()
                  ..color = color.withOpacity((1 - particle.progress * 2).clamp(0, 0.5))
            ...
            child: Particle.generate(
              ...
              generator: (i) {
                ...
                return MovingParticle(
                  curve: const Interval(0.0, 0.1, curve: Curves.decelerate),
                  to: Vector2(
                    ...
                    renderer: (canvas, particle) {
                      ...
                      canvas.drawRRect(
                        RRect.fromRectAndRadius(
                          rect,
                          Radius.circular(particleSize / 4),
                        ),
                        paint,
                      );
                      canvas.restore();
